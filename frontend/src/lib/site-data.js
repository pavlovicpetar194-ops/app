...
export const BENEFITS = [
  {
    icon: "Leaf",
    title: "100% prirodno",
    desc: "Bez veštačkih aroma, šećera i konzervansa.",
  },
  {
    icon: "ShieldCheck",
    title: "Bez aditiva",
    desc: "Med čist iz košnice — onakav kakav je oduvek bio.",
  },
  {
    icon: "Home",
  ...
  },
  {
    icon: "Sparkles",
    title: "Bogat ukus",
    desc: "Karakter, dubina i miris cveta u svakoj kašičici.",
  },
  {
    icon: "Handshake",
    title: "Direktno od pčelara",
    desc: "Bez posrednika — najpošteniji put od košnice do vas.",
  },
];
